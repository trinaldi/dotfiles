...
SHADER_PATH="/home/tiago/.config/mpv/shaders"
...
# Need a good GPU
SMOOTH_UHD=true
SMOOTH_UHD_HIFPS=true
SMOOTH_FHD=true
SMOOTH_FHD_HIFPS=true
SMOOTH_HD=true
SMOOTH_HD_HIFPS=true
SMOOTH_SD=true
SMOOTH_SD_HIFPS=true
...
VS_PATH="/home/tiago/.config/mpv/vapoursynth.py"

# VAPOURSYNTH
#------------------------------------
# Use VapourSynth (true) or not (false) [default: false]
# Need a good CPU
VAPOURSYNTH_UHD=true
VAPOURSYNTH_UHD_HIFPS=true
VAPOURSYNTH_FHD=true
VAPOURSYNTH_FHD_HIFPS=true
VAPOURSYNTH_HD=true
VAPOURSYNTH_HD_HIFPS=true
VAPOURSYNTH_SD=true
VAPOURSYNTH_SD_HIFPS=true
#########################################
# END USER SETTINGS
#########################################
...
# START MPV
/home/tiago/bin/mpv-build/mpv/build/mpv --video-sync=display-resample ${VO} ${VF} ${VS} ${AUDIO} "${MOVIE}"
